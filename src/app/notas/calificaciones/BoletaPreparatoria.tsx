...
export const BoletaPreparatoria = React.forwardRef(({ alumno, unidadActual = 3, seccion }: any, ref: any) => {
  ...
  // 2. Lógica de Subtítulos (Manteniendo tu estructura)
  ...
  return (
    ...
    >
      {/* 1. Fondo de la Boleta - Preparatoria */}
      <img
        src="/fondo_boleta_preparatoria.jpg"
        className="absolute inset-0 w-full h-full object-fill z-0"
        alt="Fondo Preparatoria"
      />
      ...
      <div className="absolute top-[211px] left-[440px] text-[16px] font-bold text-blue-900 uppercase italic z-10 w-[320px]">
        ...
        {/* Cambiado a PREPARATORIA */}
        <p className="mb-[10px]">PREPARATORIA {obtenerLetraSeccion()}</p>
      ...
      {/* 5. TÍTULO DE COMPORTAMIENTO (Si el fondo no lo trae) */}
...
BoletaPreparatoria.displayName = "BoletaPreparatoria";