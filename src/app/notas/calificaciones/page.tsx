...
export default function CalificacionesPage() {
  ...
  const [anioEscolar, setAnioEscolar] = useState<number>(
...
const materiasPrimariaAlta = [
  ...
  const bloquesBasicoBase = {
    1: [
      ...
      {
        id_materia: 248,
        materia: "Culturas e Idiomas Mayas, Garífuna o Xinca",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 210,
        materia: "Comunicación y Lenguaje, Idioma Español",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 201,
        materia: "Comunicación y Lenguaje Idioma Extranjero",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
  ...
  const bloqueResponsabilidad = [
    ...
    {
      id_materia: 257,
      materia: "Completa Trabajos a Tiempo",
      tipo: "Texto_Primaria",
      u1: "",
      u2: "",
      u3: "",
    ...
    {
      id_materia: 258,
      materia: "Participa en actividades de aprendizaje",
      tipo: "Texto_Primaria",
      u1: "",
      u2: "",
      u3: "",
    ...
    {
      id_materia: 260,
      materia: "Atiende juntas de padres",
      tipo: "Texto_Primaria",
      u1: "",
      u2: "",
      u3: "",
    ...
    {
      id_materia: 261,
      materia: "Práctica diariamente lo estudiado",
      tipo: "Texto_Primaria",
      u1: "",
      u2: "",
      u3: "",
  ...
  const PENSUM_MEDIO: Record<string, any[]> = {
    "17": [
      ...
      {
        id_materia: 263,
        materia: "Comunicación Y Lenguaje L3 (Inglés Técnico) 4",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 264,
        materia: "Tecnología de Información y la comunicación 4",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
    ...
    "18": [
      ...
      {
        id_materia: 269,
        materia: "Comunicación Y Lenguaje L3 (Inglés Técnico) 5",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 270,
        materia: "Tecnología de Información y la comunicación 5",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 273,
        materia: "Ciencias Sociales y Formación Ciudadana 5",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
  ...
  const PENSUM_PERITO_B1: Record<string, any[]> = {
    "19": [
      ...
      {
        id_materia: 275,
        materia: "Redacción y Correspondencia Mercantil",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 276,
        materia: "Ortografía y Caligrafía",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
    ...
    "20": [
      ...
      {
        id_materia: 281,
        materia: "Cálculo Mercantil y Financiero",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 283,
        materia: "Legislación Fiscal y Aduana",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
    ...
    "21": [
      ...
      {
        id_materia: 290,
        materia: "Contabilidad Gubernamental Integrada",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 293,
        materia: "Ética Profesional y Relaciones Humanas",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 295,
        materia: "Derecho Mercantil y Nociones de Derecho Laboral",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
      ...
      {
        id_materia: 297,
        materia: "Seminario sobre problemas socio económicos de Guatemala",
        tipo: "Numerica",
        u1: "",
        u2: "",
        u3: "",
  ...
  const puedeEditarMateria = (idM: number) => {
    ...
    if (esPrePrimariaOPrimaria) {
      const asignadoASeccion = permisos.asignaciones.some(
        (a: any) =>
          a.id_grado.toString() === grado && a.seccion.toString() === seccion,
      );
  ...
  const calcularPromedioCombinado = (
    bloque1: any[],
    bloque2: any[],
    unidad: string,
  ) => {
    ...
    const notasValidas = todasLasNumericas
      .map((m) => parseFloat(m[unidad]))
      .filter((n) => !isNaN(n));
    if (notasValidas.length === 0) return "0";
    ...
    try {
      ...
      if (datos && datos.length > 0) {
        const agrupados = datos.reduce((acc: any, curr: any) => {
          const nom = curr.NOMBRES || curr.nombres || "";
          const ape = curr.APELLIDOS || curr.apellidos || "";
          const nombre =
            curr.nombre_completo || curr.NOMBRE || `${nom} ${ape}`.trim();
  ...
  const guardarNotasAlumno = async (idAlumno: number) => {
    ...
    try {
      ...
      const esPerito = ["19", "20", "21"].includes(
        estudiante.id_grado.toString(),
      );
            ...
            <td key={u} className="px-1 md:px-3 py-4 text-center">
              {m.tipo === "Numerica" ? (
                <input
                  ...
                  className={`w-[50px] md:w-[70px] h-[45px] border-2 rounded-xl text-center font-black outline-none transition-all ${finalDisabled ? "bg-gray-100/50 border-gray-100 text-gray-400 cursor-not-allowed" : "bg-white border-gray-200 focus:border-red-600"} ${estaReprobado ? "text-red-600 bg-red-50 border-red-200" : ""}`}
                />
              ) : (
                <select
                  value={m[u]}
                  ...
                  disabled={finalDisabled}
                  className={`w-full md:w-[80px] h-[45px] border-2 rounded-xl text-[9px] md:text-[10px] font-black text-center outline-none transition-all ${finalDisabled ? "bg-gray-100/50 border-gray-100 text-gray-400 cursor-not-allowed" : "bg-white border-gray-200 focus:border-red-600"}`}
                >
                  <option value="">-</option>
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 pb-20">
      <header className="bg-[#E60000] text-white shadow-lg p-4 md:p-6 flex flex-col md:flex-row justify-between items-center sticky top-0 z-50 gap-4">
        ...
        <div className="flex flex-col md:flex-row items-center gap-6">
          <Link
            href="/notas"
            className="px-6 py-3 bg-white text-[#E60000] rounded-xl font-black text-xs uppercase shadow-md hover:bg-gray-100 transition-colors"
          >
            Menú
          </Link>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 md:px-6 py-10">
        <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-6 md:p-8 mb-6 flex flex-col md:flex-row items-end gap-4 md:gap-6">
          ...
          <button
            ...
            disabled={cargando}
            className="w-full md:w-auto px-10 h-[58px] bg-[#17365D] text-white rounded-2xl font-black shadow-lg hover:bg-slate-800 transition-all uppercase text-xs"
          >
            ...
            <div className="bg-white/95 backdrop-blur-md border border-gray-200 shadow-sm rounded-3xl p-3 flex flex-col md:flex-row md:items-center justify-between gap-4">
              <div className="flex items-center gap-4 ml-2 md:ml-6">
                ...
                <div className="flex flex-col">
                  <span className="text-gray-400 font-black text-[9px] uppercase tracking-tighter">
                    Planilla Digital
                  </span>
                  ...
                  <div className="flex gap-1 md:gap-2 mr-2 border-r border-gray-200 pr-2 md:pr-4 items-center">
                    ...
                    {unidadesHabilitadas.map((u) => (
                      <button
                        ...
                        className="w-8 h-8 flex items-center justify-center bg-gray-100 hover:bg-[#E60000] hover:text-white rounded-lg font-black text-xs transition-colors shadow-sm text-gray-500"
                      >
                        {u}
                      </button>
                    ))}
          ...
          return (
            ...
            >
              <div
                ...
                className="bg-white border-b border-gray-50 hover:bg-gray-50 p-4 md:p-6 flex justify-between items-center cursor-pointer transition-colors"
              >
                <div className="flex items-center space-x-4 md:space-x-6">
                  <div className="w-10 h-10 md:w-12 md:h-12 rounded-2xl bg-[#E60000] text-white flex items-center justify-center font-black text-xs md:text-sm uppercase shadow-sm">
                ...
                <div className="flex items-center gap-4">
                  {estaGuardandoEsteAlumno && (
                    <span className="text-[10px] font-black text-red-500 animate-pulse uppercase tracking-widest bg-red-50 px-3 py-1 rounded-lg border border-red-100 shadow-sm">
                      Guardando...
                    </span>
                  )}
                  <div
                  ...
                  <table className="w-full min-w-[600px]">
                    <thead className="bg-gray-50 text-[10px] text-gray-400 uppercase font-black tracking-widest text-center border-b border-gray-100">
                      <tr>
                        ...
                        <th
                          className={`py-4 ${unidadesHabilitadas.includes(1) ? "text-gray-800" : "opacity-30"}`}
                        >
                          U I
                        </th>
                        <th
                          className={`py-4 ${unidadesHabilitadas.includes(2) ? "text-gray-800" : "opacity-30"}`}
                        >
                          U II
                        </th>
                        <th
                          className={`py-4 ${unidadesHabilitadas.includes(3) ? "text-gray-800" : "opacity-30"}`}
                        >
                          U III
                        </th>
                        <th
                          className={`py-4 ${unidadesHabilitadas.includes(4) ? "text-gray-800" : "opacity-30"}`}
                        >
                          U IV
                        </th>
                      </tr>
                    ...
                    <tbody className="divide-y divide-gray-100">
                      {esPreVisual ? (
                        <>
                          <tr className="bg-red-50/30 text-left">
                            <td
                              colSpan={5}
                              className="px-4 md:px-10 py-4 font-black text-red-700 uppercase text-[10px] tracking-widest"
                            >
                              Áreas Curriculares
                            </td>
                          </tr>
                          ...
                          <tr className="bg-yellow-50/30 text-left border-t-4 border-white">
                            <td
                              colSpan={5}
                              className="px-4 md:px-10 py-4 font-black text-yellow-700 uppercase text-[10px] tracking-widest"
                            >
                              Aspectos
                            </td>
                          </tr>
                        ...
                        (() => {
                          const esPrimaria = [
                            ...
                            "9",
                            "10",
                          ].includes(est.id_grado.toString());
                          const esBasico = ["14", "15", "16"].includes(
                            est.id_grado.toString(),
                          );
                          const esBachillerato = ["17", "18"].includes(
                            est.id_grado.toString(),
                          );
                          const esPerito = ["19", "20", "21"].includes(
                            est.id_grado.toString(),
                          ...
                          if (esPrimaria) areasRender = areasPrimaria;
                            ...
                            areasRender = areasBachillerato;
                          else if (esPerito) areasRender = areasPerito;

                          return areasRender.map(
                            (area) =>
                              est.bloques[area.id] &&
                              est.bloques[area.id].length > 0 && (
                                <React.Fragment key={area.id}>
                                  <tr>
                                    <td
                                      colSpan={5}
                                      className="px-4 md:px-10 py-4 font-black text-gray-700 uppercase text-[10px] bg-gray-50/50 text-left tracking-widest border-t-4 border-white"
                                    >
                                      {area.titulo}
                                    </td>
                                  </tr>
                                  ...
                                  {!esPerito && area.id === 1 && (
                                    <tr className="bg-red-50/50 font-black text-[#E60000] border-t-2 border-red-100">
                                      <td className="px-4 md:px-10 py-4 text-right text-[10px] uppercase tracking-widest">
                                        Promedio Exacto
                                      </td>
