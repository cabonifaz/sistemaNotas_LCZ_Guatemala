...
const MATERIAS_POR_GRADO: Record<string, number[]> = {
  ...
  // Básico
  // Básico (Actualizado CNB con texto y numéricas)
  "14": [
  ...
  // Diversificado
  // Diversificado (Se integraron los bloques extracurriculares y de responsabilidad)
  // Diversificado
  "17": [
    262, 263, 264, 265, 266, 267, 228, 245, 205, 234, 203, 242, 247, 251, 233,
    252, 253, 254, 255, 256, 257, 258, 259, 260, 261,
  ],
  // Quinto Bachillerato (Actualizado)
  "18": [
    268, 269, 270, 271, 272, 219, 217, 273, 229, 207, 242, 247, 251, 233, 252,
    253, 254, 255, 256, 257, 258, 259, 260, 261,
  ],
  // Cuarto Perito (Actualizado con 4 bloques)
  "19": [
    202, 237, 211, 274, 275, 222, 276, 277, 278, 279, 238, 266, 280, 251, 233,
    252, 253, 254, 255, 256, 257, 258, 259, 260, 261,
  ],
  // Quinto y Sexto Perito (Actualizados con todas sus materias exactas)
  "20": [
