...
export default function DashboardPage() {
  ...
  // FUNCIÓN: Extrae las iniciales del nombre
  ...
  return (
    <div className="p-8 bg-white min-h-screen">
      ...
      {/* 🔴 BANNER CON LOGO EN MARCA DE AGUA */}
      <div className="bg-[#E60000] rounded-3xl p-10 flex flex-col md:flex-row justify-between items-center mb-10 shadow-xl shadow-red-200 relative overflow-hidden">
        ...
        <div className="relative z-10 text-left">
          <h2 className="text-white text-4xl font-black tracking-tight leading-none mb-1">
            Liceo Cristiano
          </h2>
          <h2 className="text-[#FFD700] text-5xl font-black tracking-tight leading-none mb-6">
            Zacapaneco
          </h2>
          ...
          {usuario?.rol === "Admin" && (
            <>
              <Link
                ...
                className="px-10 py-4 bg-[#FFD700] hover:bg-yellow-400 text-yellow-900 text-xs font-black rounded-2xl shadow-lg transition-all hover:scale-105 active:scale-95 text-center"
              >
                INSCRIBIR ALUMNO
              </Link>
              <Link
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col justify-between h-48 hover:border-red-100 transition-colors group">
          ...
          <div className="text-left">
            ...
            <div className="flex items-baseline space-x-2">
              ...
              <span className="text-[9px] font-bold text-yellow-600 bg-yellow-50 px-2 py-0.5 rounded-full uppercase">
                Ciclo 2026
              </span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col justify-between h-48 hover:border-red-100 transition-colors group">
          ...
          <div className="text-left">
            ...
            <div className="flex items-baseline space-x-2">
              ...
              <span className="text-[9px] font-bold text-[#E60000] bg-red-50 px-2 py-0.5 rounded-full uppercase">
                Nómina
              </span>
            </div>
          </div>
        ...
        <div className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 flex flex-col justify-between h-48 hover:border-red-100 transition-colors group">
          ...
          <div className="text-left">
            ...
            <div className="flex items-baseline space-x-2">
              ...
              <span className="text-[9px] font-bold text-gray-400 border border-gray-200 px-2 py-0.5 rounded-full uppercase">
                CNB
              </span>
            </div>
          </div>
